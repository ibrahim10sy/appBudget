...
class _BudgetDetaille extends State<BudgetDetaille> {
  ...
  void initState() {
    ...
    _futureListDepense =
        depenseService.getDepenseByIdBudget(widget.budget.idBudget!);
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Container(
                                                                              ...
                                                                              decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(13), boxShadow: const [
                  ...
                  children: [
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                Image.asset("assets/images/depenses 1.png",
                                    width: 39, height: 39),
                                const Expanded(
                                  //flex: 4,
                                  child: Padding(
                    ...
                    Consumer<DepenseService>(
                      ...
                      return FutureBuilder<List<DepenseClass>>(
                          future:
                              _futureListDepense, //depenseServices.getDepenseByIdBudget(widget.budget.idBudget!),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => Depense(dedepenses: depense)));
      },
      child: Container(
        margin: index == 0
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset("assets/images/depenses 1.png",
                        width: 33, height: 33),
                  ),
                  Expanded(
                      child: Text(
    ...
    return Row(
      ...
      children: [
        IconButton(
            onPressed: () {
              setState(() {
                _futureListDepense = depenseService
                    .getDepenseByIdBudget(widget.budget.idBudget!);
              });
            },
