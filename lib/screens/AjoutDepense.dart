...
class _AjoutState extends State<AjoutDepense> {
  ...
  String? selectedType;
  String? selectDate;
  String dropdownValue = 'quotidien';
                                  ...
                                  onTap: () async {
                                    ...
                                    if (pickedDate != null) {
                                      ...
                                      setState(() {
                                        ...
                                        dateInput.text = selectDate!;
                                      });

                                      // Appeler votre fonction de sauvegarde de données ici en utilisant la valeur de selectedDate
                                      // saveToDatabase(selectedDate);
                                    } else {
                                      // Gérer le cas où l'utilisateur n'a pas sélectionné de date
                                    }
                                  },
                                )
                                  ),
                                ...
                                ElevatedButton(
                                    style: ElevatedButton.styleFrom(
                                        ...
                                        shape: RoundedRectangleBorder(
                                            ...
                                            BorderRadius.circular(13))),
                                    // onPressed: (){
                                    //   debugPrint(montantController.text);
                                    //   _ajouterDepense();
                                    // },
                                    onPressed: () async{
